...
Long story short, Apple broke a lot of older printers starting with recent OS versions (like iOS 17). They became a lot more picky about mDNS records and how their devices communicate with network-based printers. Unfortunately, they never told anyone what they did, and many device manufacterers haven't released updated printer firmware to match new requirements. So, this fixes that disconnect (without any help from Apple).
