...
**IMPORTANT**: *You still need some sort of custom mDNS/Avahi service file to pair with this script, assuming your current multicast broadcast service is also incompatible. I've included a sample Avahi service file, but yours needs to fit (relatively) closely with your specific printer!*
