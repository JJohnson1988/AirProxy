...
NOTE that you still need some sort of custom mDNS/Avahi service to pair with this script, assuming your current multicast broadcast service is also incompatible. I've included a sample Avahi service, but yours needs to fit (relatively) closely with your specific printer!
